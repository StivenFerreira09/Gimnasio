...
Actualmente, la gestión de un gimnasio puede realizarse de manera manual o utilizando diferentes herramientas para controlar clientes, membresías, pagos, clases y entrenadores.
...
| Usuario | Función | Acciones principales |
|---|---|---|
| **Administrador** | Administra y supervisa la información general del gimnasio. | Administrar clientes, membresías, pagos, clases, entrenadores, dashboard, reportes, roles y permisos. |
| **Recepcionista** | Realiza actividades operativas del gimnasio mediante el sistema. | Registrar y consultar clientes, gestionar membresías y pagos, consultar y gestionar clases según permisos y consultar entrenadores. |
| **Entrenador** | Dirige las clases que le sean asignadas. | Iniciar sesión, consultar clases asignadas, horarios e información de las clases. |
| **Cliente** | Utiliza los servicios del gimnasio mediante una cuenta personal. | Consultar información, membresía, pagos, clases, inscribirse y cancelar inscripciones. |
...
**Como** administrador o personal del gimnasio,  
**quiero** registrar un nuevo cliente,  
**para** almacenar su información y poder gestionarla desde el sistema.
...
**Como** administrador o personal del gimnasio,  
**quiero** buscar un cliente por sus datos identificativos,  
...
**Como** administrador o personal autorizado,  
...
**para** evitar que continúe apareciendo como cliente activo cuando ya no utiliza los servicios del gimnasio.
...
**Como** cliente,  
**quiero** consultar la información de mi membresía,  
**para** conocer el plan que tengo contratado y su estado.
...
**Como** administrador,  
**quiero** crear diferentes tipos de membresía,  
...
**Como** administrador o personal autorizado,  
**quiero** consultar las membresías disponibles,  
**para** conocer las opciones ofrecidas por el gimnasio.
...
**Como** administrador o personal autorizado,  
**quiero** asignar una membresía a un cliente,  
**para** registrar el servicio contratado.
...
**Como** administrador,  
**quiero** consultar las membresías activas, vencidas y próximas a vencer,  
...
**para** mantener activo mi acceso a los servicios del gimnasio.
...
**Como** administrador o personal autorizado,  
**quiero** registrar el pago realizado por un cliente,  
**para** mantener actualizado su historial de pagos.
...
**Como** cliente,  
**quiero** consultar mi historial de pagos,  
**para** conocer los pagos que he realizado al gimnasio.
...
**Como** administrador,  
**quiero** consultar los ingresos generados por los pagos,  
**para** conocer el comportamiento económico del gimnasio.
...
**Como** administrador,  
**quiero** generar reportes de pagos,  
**para** analizar y respaldar la información financiera del gimnasio.
...
**Como** administrador,  
**quiero** crear una clase,  
**para** organizar las actividades ofrecidas por el gimnasio.
...
**Como** administrador,  
**quiero** asignar un entrenador a una clase,  
**para** organizar quién estará encargado de dirigirla.
...
**Como** cliente,  
**quiero** consultar las clases disponibles,  
**para** conocer las actividades a las que puedo inscribirme.
...
**Como** cliente,  
**quiero** inscribirme en una clase disponible,  
**para** participar en las actividades del gimnasio.
...
**Como** cliente,  
**quiero** cancelar mi inscripción en una clase,  
**para** liberar el cupo cuando no pueda participar.
...
**Como** administrador o personal autorizado,  
**quiero** consultar los clientes inscritos en una clase,  
**para** conocer la cantidad de participantes.
...
**Como** administrador,  
**quiero** registrar entrenadores,  
**para** mantener organizada la información del personal encargado de las clases.
...
**Como** administrador,  
**quiero** editar la información de un entrenador,  
**para** mantener sus datos actualizados.
...
**Como** administrador o personal autorizado,  
**quiero** consultar los entrenadores registrados,  
**para** conocer la información del personal disponible.
...
**para** conocer las clases que tengo asignadas.
...
**Como** administrador,  
**quiero** consultar un dashboard con información general del gimnasio,  
**para** conocer rápidamente el estado de la operación.
...
**Como** administrador,  
**quiero** consultar las membresías próximas a vencer,  
**para** realizar un seguimiento de los clientes que deben renovar.
...
**Como** administrador,  
**quiero** consultar los ingresos por período,  
**para** analizar los ingresos generados por el gimnasio.
...
**para** proteger mi cuenta cuando termine de utilizar el sistema.
...
**para** poder volver a acceder a mi cuenta cuando la haya olvidado.
...
**Como** administrador,  
**quiero** administrar los roles y permisos de los usuarios,  
...
|---|---|
| **Gestión de clientes** | Registrar clientes, consultar clientes, buscar clientes, editar información y consultar membresía asociada. |
| **Gestión de membresías** | Crear tipos de membresía, consultar membresías, asignar membresía a clientes, consultar estado y fechas de vencimiento. |
| **Gestión de pagos** | Registrar pagos, consultar historial de pagos y permitir al cliente consultar sus propios pagos. |
| **Gestión de clases** | Crear clases, definir horarios y capacidad, asignar entrenadores, consultar clases disponibles y permitir a los clientes inscribirse. |
| **Gestión de entrenadores** | Registrar entrenadores, consultar entrenadores y asignar entrenadores a clases. |
| **Dashboard y reportes** | Consultar clientes activos, membresías activas y vencidas, pagos realizados, clases programadas y membresías próximas a vencer. |
| **Autenticación y permisos** | Iniciar sesión, cerrar sesión, administrar roles y permisos y controlar el acceso según el tipo de usuario. |
