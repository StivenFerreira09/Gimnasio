...
| Usuario | Función |
| --- | --- |
| Administrador | Es el usuario encargado de administrar y supervisar la información general del gimnasio. Podrá: Administrar clientes. Administrar membresías. Gestionar clases. Gestionar entrenadores. Consultar el dashboard. Consultar información y reportes. Administrar roles y permisos. |
...
| Categorìa | Descripción | Acción recomendada |
| --- | --- | --- |
...
El sistema debe permitir al administrador o personal autorizado seleccionar un cliente.

El sistema debe mostrar la membresía actual del cliente.

El sistema debe permitir iniciar el proceso de renovación.

El sistema debe actualizar la vigencia de la membresía.

El sistema debe establecer la nueva fecha de vencimiento según la duración de la membresía.

El sistema debe mostrar una confirmación cuando la renovación se realice correctamente.
...
| Gestión de pagos | Registrar pagos · Consultar historial de pagos · Permitir al cliente consultar sus propios pagos |
...
| Dashboard y reportes | Consultar clientes activos · Consultar membresías activas y vencidas · Consultar pagos realizados · Consultar clases programadas · Consultar membresías próximas a vencer |
